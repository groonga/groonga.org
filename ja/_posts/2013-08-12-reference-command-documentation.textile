...
ドキュメントを随時追加しているのですが、リファレンスマニュアルのコマンドについては、新旧のフォーマットが混在していて、統一されていないのが現在の課題となっています。
...
新しいほうのフォーマットに直してあるものは http://groonga.org/ja/docs/reference/command.html の一覧で見たときにコマンド名がボールド体で表記されます。
